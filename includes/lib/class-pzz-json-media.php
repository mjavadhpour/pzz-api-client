...
require_once plugin_dir_path(dirname(__FILE__)) . 'lib/api/class-pzz-api-controller.php';
/**
 * @since 1.1.1
 */
class PZZ_JSON_Media extends PZZ_API_Controller
{
     ...
     * @since 1.1.1
     */
    public function get_post($id, $current_user, $context = 'view')
    {
        $id = (int) $id;
        ...
        return parent::get_post($id, $current_user, $context);
    }
