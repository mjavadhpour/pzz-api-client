...
class Pzz_Api_Client
{
    ...
    private function load_dependencies()
    {
         ...
         * core plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/pzz-api-client-loader.class.php';

        /**
         * The class responsible for create APIs and response to the API calls.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/pzz-json-posts-controller.class.php';

        /**
         *  The helper classes.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/utils/pzz-datetime.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/utils/pzz-url.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/utils/pzz-mysql.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/utils/pzz-post.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-comments.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-meta.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-meta-posts.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-responseinterface.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-response.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-users.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-media.class.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/lib/pzz-json-taxonomies.class.php';
